 ...
 */
FARPROC WINAPI GilharCalcDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = GilharCalcDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = GilharCalcDelayLoadWin32FailureHook;
#endif
